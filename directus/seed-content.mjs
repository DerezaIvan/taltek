...
const content = {
  ...
  about_intro: [
    {
      ...
      lead: '16 лет мы предлагаем комплексные транспортные решения и организуем перевозку грузов широкой номенклатуры в различных видах подвижного состава на внутрироссийских и экспортных направлениях.',
      paragraphs: [
  ...
  why_us_items: [
    ...
    },
    {
      ...
      description: '16 лет на рынке транспортно-логистических услуг.',
      sort: 5,
      status: 'published',
    },
    {
      ...
      description: '115 профессионалов своего дела.',
      sort: 6,
      status: 'published',
    },
  ],
  ...
  what_you_get_items: [
    ...
    { id: 'deal-speed', title: 'Оперативный выход на сделку', sort: 4, status: 'published' },
    {
      id: 'fleet-selection',
  ...
  stats_items: [
    ...
    },
    {
      ...
      label: 'Грузооборот',
      value: '3,5 млрд',
      description: 'тонно-км ежемесячно',
      sort: 2,
      status: 'published',
    },
    {
  ...
  fleet_park_cards: [
    {
      ...
      badge: '40% — инновационная модель 12-2159',
      sort: 1,
      status: 'published',
    },
    {
      ...
      value: '3 510',
      label: 'Крытые вагоны',
      badge: 'большекубовая модель 11-2163',
      sort: 2,
      status: 'published',
    },
    {
  ...
  contract_contacts_cards: [
    {
      ...
      email: 'i.barbitskiy@taltektrans.pro',
      sort: 1,
      status: 'published',
    },
    {
  ...
  operations_dispatchers: [
    {
      id: 'gondola',
      title: 'Полувагоны',
      phone: '8 800 533 9 888 доб. 382',
      phone_href: 'tel:+78005339888,382',
      badge: 'Круглосуточно',
      phone2: '+7 921 763 31 97',
      phone_href2: 'tel:+792176303197',
    ...
    },
    {
      id: 'covered-grain',
      title: 'Крытые вагоны',
      phone: '8 800 533 9 888 доб. 726',
      phone_href: 'tel:+78005339888,726',
      badge: 'Режим работы: 08:00 – 20:00 (по МСК)',
      phone2: '+7 921 430 93 79',
      phone_href2: 'tel:+79214309379',
