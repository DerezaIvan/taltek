...
const content = {
  ...
  what_you_get_items: [
    ...
    { id: 'route-planning', title: 'Эффективное планирование маршрутов', sort: 2, status: 'published' },
    { id: 'support', title: 'Квалифицированная техническая поддержка', sort: 3, status: 'published' },
    { id: 'deal-speed', title: 'Высокая скорость заключения сделки', sort: 4, status: 'published' },
    { id: 'fleet-selection', title: 'Высокая скорость подбора подвижного состава', sort: 5, status: 'published' },
  ...
  privacy_sections: [
    {
      ...
      blocks: [
        { type: 'paragraph', text: '1.1. Использование сайта означает согласие пользователя с настоящей Политикой.' },
        { type: 'paragraph', text: '1.2. Если пользователь не согласен с условиями настоящей Политики, он должен прекратить использование сайта.' },
        { type: 'paragraph', text: '1.3. Настоящая Политика применяется исключительно к официальному сайту Компании и не распространяется на сайты третьих лиц, ссылки на которые могут размещаться на сайте.' },
      ],
      sort: 1,
      status: 'published',
    },
    {
      ...
      blocks: [
        ...
        { type: 'paragraph', text: 'Контактные данные указываются в разделе «Контакты» официального сайта.' },
      ],
      sort: 2,
      status: 'published',
    },
    {
      ...
      blocks: [
        { type: 'paragraph', text: 'Компания может обрабатывать следующие категории персональных данных:' },
        {
          type: 'list',
          items: [
    ...
    },
    {
      ...
      blocks: [
        { type: 'paragraph', text: 'Персональные данные обрабатываются исключительно для следующих целей:' },
        {
          type: 'list',
          items: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'list',
          items: ['законность;', 'конфиденциальность;', 'актуальность;', 'доступность;', 'защиту от неправомерного доступа, изменения, распространения, уничтожения и иных неправомерных действий.'],
        },
      ],
      sort: 6,
      status: 'published',
    },
    {
      ...
      blocks: [
        { type: 'paragraph', text: 'Компания не передает персональные данные третьим лицам, за исключением случаев:' },
        {
          type: 'list',
          items: [
    ...
    },
    {
      ...
      blocks: [
        { type: 'paragraph', text: 'Сайт может использовать файлы cookie и аналогичные технологии для:' },
        {
          type: 'list',
          items: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'paragraph', text: 'Актуальная редакция Политики всегда размещается на официальном сайте Компании.' },
      ],
      sort: 12,
      status: 'published',
    },
    {
      ...
      blocks: [
        ...
        { type: 'paragraph', text: 'Дата вступления Политики в силу определяется датой ее опубликования на сайте.' },
      ],
      sort: 13,
      status: 'published',
    },
