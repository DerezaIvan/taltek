...
const content = {
  ...
  operations_contacts_section: {
    dispatchers_title: 'Диспетчерский центр',
  ...
  operations_dispatchers: [
    {
      ...
      badge: 'Круглосуточно',
      phone2: '8 800 533 9 888 доб. 201',
      phone_href2: 'tel:+78005339888,201',
      email: 'gondola@taltektrans.pro',
      sort: 1,
      status: 'published',
    },
    {
