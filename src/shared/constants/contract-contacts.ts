...
export const CONTRACT_CONTACTS_CARDS = [
  {
    ...
    phone: `${CONTRACT_CONTACTS_PHONE.display} доб. 204`,
    phoneHref: `${CONTRACT_CONTACTS_PHONE.href},204`,
  ...
  },
  {
    ...
    phone: `${CONTRACT_CONTACTS_PHONE.display} доб. 206`,
    phoneHref: `${CONTRACT_CONTACTS_PHONE.href},206`,
  ...
  },
  {
    ...
    phone: `${CONTRACT_CONTACTS_PHONE.display} доб. 220`,
    phoneHref: `${CONTRACT_CONTACTS_PHONE.href},220`,
